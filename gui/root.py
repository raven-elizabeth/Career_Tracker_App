...
class Root(Tk):
    """The Root class is the main window of the application.
    It sets the window title, minimum size, and starts maximised
    to provide a consistent user experience.
    It is passed as the parent to all screens,
    which are then packed and unpacked to navigate between them.
    Minimum sizes are chosen to ensure all content fits and is not cut off.
    Would like to add responsive design in the future for smaller sizes,
