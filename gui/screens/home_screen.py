...
class HomeScreen(Screen):
    ...
    def _configure_grid(self):
        """Set row and column weights. Padding rows at top, middle, and
        bottom."""
    ...
    def _create_header_frame(self):
        """Create the header frame with icon, main heading, welcome message,
    ...
    def _create_options_frame(self):
        """Create options frame with subheading and buttons for creating a
        new entry or browsing existing entries."""
    ...
    def _add_button(self, title, subtitle, func, row):
        """Create and grid a stylised option button inside the options
        frame."""
