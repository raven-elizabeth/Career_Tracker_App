...
Stored separately to avoid circular imports and to centralise field management,
supporting the open/closed principle — adding a field here propagates automatically.
